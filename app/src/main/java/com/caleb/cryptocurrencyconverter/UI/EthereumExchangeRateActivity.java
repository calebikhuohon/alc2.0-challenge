...
public class EthereumExchangeRateActivity extends AppCompatActivity {
    ...
    ArrayList<ExchangeRate> ethExchangeRates = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ethereum_exchange_rate);

        ExchangeRateTask task = new EthereumExchangeRateActivity.ExchangeRateTask();
        task.execute();
    ...
    private void updateUi(final ArrayList<ExchangeRate> exchangeRate) {
        ...
        ExchangeRateAdapter adapter = new ExchangeRateAdapter(this, ethExchangeRates);
        ...
        exchangeRateListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ExchangeRate exRate = ethExchangeRates.get(i);
                Bundle bundle = new Bundle();
                bundle.putString(EXRATE_TEXT, exRate.getText());
                bundle.putDouble(EXRATE_VALUE, exRate.getExRateValue());
                Intent intent = new Intent(EthereumExchangeRateActivity.this, ConversionActivity.class);
    ...
    private ArrayList<ExchangeRate> extractRatesFromJson(String exchangeRateJson) {
        ...
        try {
            ...
            JSONObject btc = jsonResponse.getJSONObject("ETH");
            ...
            ethExchangeRates.add(new ExchangeRate("Naira", ngn));
            ethExchangeRates.add(new ExchangeRate("Dollar", usd));
            ethExchangeRates.add(new ExchangeRate("Euro", eur));
            ethExchangeRates.add(new ExchangeRate("Yen", jpy));
            ethExchangeRates.add(new ExchangeRate("Pound", gbp));
            ethExchangeRates.add(new ExchangeRate("Swiss Franc", chf));
            ethExchangeRates.add(new ExchangeRate("Rupee", inr));
            ethExchangeRates.add(new ExchangeRate("Canadian Dollar", cad));
            ethExchangeRates.add(new ExchangeRate("Dinar", dzd));
            ethExchangeRates.add(new ExchangeRate("Austrailia Dollar", aud));
            ethExchangeRates.add(new ExchangeRate("Singapore Dollar", sgd));
            ethExchangeRates.add(new ExchangeRate("China Yuan", cny));
            ethExchangeRates.add(new ExchangeRate("South Africa Rand", zar));
            ethExchangeRates.add(new ExchangeRate("New Zealand Dollar", nzd));
            ethExchangeRates.add(new ExchangeRate("Ethereum", eth));


        } catch (JSONException e)

        {
            Log.e("EthExchangeActivity", "Problem parsing the earthquake JSON results", e);
        }
